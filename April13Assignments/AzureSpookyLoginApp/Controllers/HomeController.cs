...
namespace AzureSpookyLoginApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(SpookyRequest spookyrequest)
        {
            ...
            {
                HttpResponseMessage response = await client.PostAsync("https://prod-14.eastasia.logic.azure.com:443/workflows/076074493acf48eeb48a1d96c96e093c/triggers/When_an_HTTP_request_is_received/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2FWhen_an_HTTP_request_is_received%2Frun&sv=1.0&sig=agiNoxiBwcEE6e5L4ExMUJxG7acHYMjzwfgZK51t2VY", content);
